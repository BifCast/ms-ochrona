    ...
    public function authenticate(Request $request): Passport
    {
        ...
        return new Passport(
            new UserBadge($identifier, function($userIdentifier) {
                    return $this->entityManager->getRepository(User::class)->findOneBy(['email' => $userIdentifier]) ?? $this->entityManager->getRepository(User::class)->findOneBy(['login' => $userIdentifier]);
                }),
